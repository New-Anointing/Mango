...
namespace Mango.Services.ShoppingCartAPI.Controllers
{
    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public CartAPIController(ApiDbContext db,
        ...
        public async Task<ResponseDto> CartUpsert(CartDto cartDto)
        {
            try
            {
                ...
                if (cartHeaderFromDb == null)
                {
                    ...
                    await _db.SaveChangesAsync();
                    cartDto.CartDetails.First().CartHeader = cartHeader;
                ...
                else
                {
                    ...
                    {
                        //create cartdetails
                        cartDto.CartDetails.First().CartHeader = cartHeaderFromDb;
                        _db.CartDetails.Add(_mapper.Map<CartDetail>(cartDto.CartDetails.First()));
                        await _db.SaveChangesAsync();
                    }
                    else
                    {
                        ...
                        cartDto.CartDetails.First().CartHeader = cartDetailsFromDb.CartHeader;
